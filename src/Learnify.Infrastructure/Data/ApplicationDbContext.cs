...
// The 'string' is for the type of the primary key for Identity tables.
{
    ...
    // Manual Payments
    public DbSet<ManualPaymentMethod> ManualPaymentMethods { get; set; }
    public DbSet<ManualPaymentRequest> ManualPaymentRequests { get; set; }
    public DbSet<ManualPaymentCartItem> ManualPaymentCartItems { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        // ManualPaymentMethod
        builder.Entity<ManualPaymentMethod>(entity =>
        {
            entity.HasIndex(m => m.Type);
        });

        // ManualPaymentRequest
        builder.Entity<ManualPaymentRequest>(entity =>
        {
            ...
            entity.HasOne(r => r.PaymentMethod)
                  .WithMany(m => m.PaymentRequests)
        ...
        // ManualPaymentCartItem
        builder.Entity<ManualPaymentCartItem>(entity =>
        {
            entity.HasOne(ci => ci.PaymentRequest)
                  .WithMany(r => r.CartItems)
                  .HasForeignKey(ci => ci.ManualPaymentRequestId)
                  .OnDelete(DeleteBehavior.Cascade);
        ...
        // LectureProgress
        builder.Entity<LectureProgress>(entity =>
        {
            ...
            entity.HasIndex(lp => new { lp.UserId, lp.LectureId })
                  .IsUnique();
        });
