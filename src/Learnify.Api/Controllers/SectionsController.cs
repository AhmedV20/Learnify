...
using Learnify.Application.Sections.Commands.DeleteSection;
...
using Learnify.Application.Sections.Queries.GetSectionById;
using Learnify.Application.Sections.Queries.GetSectionsByCourse;
using MediatR;
