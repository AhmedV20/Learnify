...
using AutoMapper;
using Learnify.Application.Lectures.Queries.GetLectureById;
using Learnify.Application.Lectures.Queries.GetLecturesBySection;
using System.Collections.Generic;
using Learnify.Application.Lectures.Commands.UpdateLecture;
using Learnify.Application.Lectures.Commands.DeleteLecture;
using Learnify.Application.Lectures.Commands.UpdateLectureOrder;
using Learnify.Application.Lectures.Commands.ToggleLecturePreview;
using Learnify.Application.Lectures.Commands.UploadVideo;
