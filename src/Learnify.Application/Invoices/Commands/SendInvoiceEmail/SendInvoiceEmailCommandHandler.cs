...
using Learnify.Application.Invoices.Queries.GenerateInvoiceHtml;
using MediatR;
using Microsoft.EntityFrameworkCore;
using System.Threading;
using System.Threading.Tasks;

namespace Learnify.Application.Invoices.Commands.SendInvoiceEmail
{
    public class SendInvoiceEmailCommandHandler : IRequestHandler<SendInvoiceEmailCommand>
    {
        ...
        public async Task Handle(SendInvoiceEmailCommand request, CancellationToken cancellationToken)
        {
            ...
            var subject = $"Your Learnify Invoice ({invoice.InvoiceNumber})";
